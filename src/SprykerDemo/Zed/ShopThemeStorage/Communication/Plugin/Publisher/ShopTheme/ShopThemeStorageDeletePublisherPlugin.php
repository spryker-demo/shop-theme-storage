 ...
 */
class ShopThemeStorageDeletePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFacade()->deleteByShopThemeEvents($eventEntityTransfers);
    }
    ...
    {
        return [
            ShopThemeStorageConfig::ENTITY_SPY_SHOP_THEME_DELETE,
        ];
    }
}
